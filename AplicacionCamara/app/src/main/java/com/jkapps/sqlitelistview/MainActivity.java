...
/** 2022-09-10
 *   ListView desde la base de datos
 *   SQLite (SQLite CRUD) Recortar y
 *   cargar imágenes una vez tomada o guardada la foto desde su respectivo almacenamiento de incoporacion de imagenes desde la barra de
 *   búsqueda de la
 *   Galería de dispositivos teniendo en cuenta su ubicacion
 *
 *
*/
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        btnList.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                toastMessage(" Volviendo a la lista...");
    ...
    public void onRequestPermissionsResult(int requestCode, @NonNull String[] permissions, @NonNull int[] grantResults) {
        if (requestCode == REQUEST_CODE_GALLERY) {
            if (grantResults.length > 0 && grantResults[0] == PackageManager.PERMISSION_GRANTED) {
                ...
                toastMessage("No tiene permiso para acceder a la ubicación del archivo");
            }
            return;
        }
    ...
    private void pickImageFromGallery() {
        ...
        startActivityForResult(Intent.createChooser(gallery, "Seleccione la Imagen ..."), REQUEST_CODE_GALLERY);
    }
