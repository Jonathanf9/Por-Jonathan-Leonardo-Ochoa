...
public class ListActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        if (mList.size() == 0) {
            toastMessage("No se han encontrado datos.");
        }
        ...
        mListView.setOnItemLongClickListener(new AdapterView.OnItemLongClickListener() {
            ...
            public boolean onItemLongClick(AdapterView<?> parent, View view, final int position, long id) {
                ...
                final CharSequence[] items = {"Leer", "Actualizar", "Borrar"};
        ...
        btnUpdate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                try {
                    ...
                    toastMessage("Actualizacion Satisfactoria.");
    ...
    private void showDialogDelete(final int position) {
        ...
        dialogDelete.setMessage("Seguro que quiere borrar la foto seleccionada?");
        dialogDelete.setPositiveButton("Si", new DialogInterface.OnClickListener() {
            @Override
            public void onClick(DialogInterface dialog, int which) {
                try {
                    mSQLiteHelper.deleteData(position);
                    toastMessage("Foto Borrada con exito.");
                }
                catch (Exception e) {
